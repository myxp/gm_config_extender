...
GM_config.trans = {
  ...
  de: {
   ...
   'ButtonSaveTip':  'Ã„nderungen speichern und Fenster schlieÃŸen',
   'ButtonCancel':   'Abbrechen',
   'ButtonCancelTip':'Fenster schlieÃŸen (Ã„nderungen verwerfen)',
   'ResetLinkName':  'ZurÃ¼cksetzen',
   'ResetLinkTip':   'Alle Werte auf Defaults zurÃ¼cksetzen',
   'ConfirmOverwriteFromClipboard': 'Sollen die Einstellungen wirklich mit den Daten vom Clipboard Ã¼berschrieben werden?',
   'SettingsSaved':  'Einstellungen gespeichert.',
   'SaveAborted':    'Aktion abgebrochen.',
   'PromptSettingsPaste': 'Bitte Einstellungen hier hineinkopieren:',
   'ConfirmOverwriteFromPaste': 'Sicher, dass die Einstellungen mit den kopierten Daten Ã¼berschrieben werden sollen?'
  },
  nl: {
   'ButtonSave': 'Opslaan',
